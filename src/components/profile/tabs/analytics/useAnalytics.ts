...
export const useAnalytics = (userId: string) => {
  return useQuery({
    ...
    queryFn: async () => {
      console.log('Fetching real analytics for user:', userId);
      ...
      console.log('Real data:', { views: viewsData, likes: likesData, comments: commentsData });
...
// Generate empty data structure when no posts exist
