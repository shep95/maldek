    ...
    <div className="container max-w-4xl px-4 sm:px-6 py-4 sm:py-8 space-y-4 sm:space-y-8 animate-fade-in">
      ...
      <Card className="p-4 sm:p-6 space-y-4 sm:space-y-6">
        <section className="space-y-3 sm:space-y-4">
          ...
          <p className="text-sm sm:text-base">Our mission since October 22 2024 is to protect human rights of speech and privacy. We do not collect any data besides email and passwords and any public posts you make including profile pictures, posts, imagines and videos.</p>
        </section>
